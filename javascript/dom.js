...
const checkbox = document.getElementById("inputBukuSukses");
...
function addTodo() {
    ...
    const BookTitle = document.getElementById("masukanJudulBuku").value;
    const BookAuthor = document.getElementById("masukanPenulisBuku").value;
    const BookYear = document.getElementById("masukanTahun").value;
    const BookIsComplete = document.getElementById("inputBukuSukses").checked;
